<template>
  <div id="main">
    ...
    <div id="log">
      <p>更新日志</p>
      <div class="log-item">
        <span>版本 4.0.0 日期时间 2020.04.11</span>
        <p>使用Vue.js重构</p>
      </div>
      <div class="log-item">
        <span>版本 3.0.0 日期时间 2020.04.08</span>
        <p>应用全局风格</p>
      </div>
      <div class="log-item">
        <span>版本 2.0.0 日期时间 2019.05.09</span>
        <p>重写JS，大幅减少代码量</p>
      </div>
      <div class="log-item">
        <span>版本 1.1.0 日期时间 2019.03.22</span>
        <p>增加八进制换算功能</p>
      </div>
      <div class="log-item">
        <span>版本 1.0.0 日期时间 2019.03.21</span>
